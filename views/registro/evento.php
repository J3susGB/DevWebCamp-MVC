    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                ...
                <source srcset="<?php echo $_ENV['HOST']; ?> img/speakers/<?php echo $evento->ponente->imagen; ?>.webp" type="image/avif">
        ...
        >
            <?php echo $evento->disponibles === "0" ? 'Agotado' : 'Añandir - ' . $evento->disponibles . ' Disponibles'; ?>
        </button>
    </div>
</div>